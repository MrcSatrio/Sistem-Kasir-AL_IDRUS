<form action="<?= base_url('koperasi/kategori/update/' . $kategori['id_kategori']) ?>" method="post" class="needs-validation">
    <h5 class="card-title"><strong>Informasi Kategori</strong></h5>

    <div class="form-group row">
        <label for="nama_kategori" class="col-sm-2 col-form-label">Nama Kategori</label>
        <div class="col-sm-10">
            <input type="text" class="form-control <?php echo session()->has('field_error.nama_kategori') ? 'is-invalid' : ''; ?>" id="nama_kategori" placeholder="Rokok" name="nama_kategori">
