<form action="<?= base_url('koperasi/siswa/create') ?>" method="post" class="needs-validation">
    ...
    <div class="form-group row">
        <label for="telp_customer" class="col-sm-2 col-form-label">Telepon Customer</label>
        <div class="col-sm-10">
    ...
    <div class="form-group row">
        <label for="nomor_kartu" class="col-sm-2 col-form-label">Nomor Kartu Customer</label>
        <div class="col-sm-10">
    ...
    <div class="form-group row">
        <label for="" class="col-sm-2 col-form-label">Saldo Kartu Customer</label>
        <div class="col-sm-10">
